...
public class loginDoctor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(signin, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 370, 90, 40));
    ...
    private void signinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signinActionPerformed
        ...
        try{
            ...
            ResultSet rs=st.executeQuery("select *from doctor where id='"+Id+"' and password='"+Pass+"'");
